...
from utils.utils import get_anchors, get_classes, get_classNums
...
if __name__ == "__main__":
    ...
    class_nums               = torch.tensor(get_classNums(num_classes, train_annotation_path))
    ...
    yolo_loss    = YOLOLoss(anchors, num_classes, input_shape, Cuda, class_nums, anchors_mask, label_smoothing)
