...
from utils.utils import cvtColor, preprocess_input, stretch_16to8
...
class YoloDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.mosaic:
            ...
            image, box      = self.get_data(self.annotation_lines[index])
    ...
    def get_data(self, annotation_line):
        ...
        image      = gdal.Open(line[0])
        image_data = stretch_16to8(image.ReadAsArray())
